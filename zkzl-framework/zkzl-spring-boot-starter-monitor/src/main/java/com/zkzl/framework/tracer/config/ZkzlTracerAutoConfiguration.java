package com.zkzl.framework.tracer.config;

import com.zkzl.framework.common.enums.WebFilterOrderEnum;
import com.zkzl.framework.tracer.core.aop.BizTraceAspect;
import com.zkzl.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "zkzl.tracer", value = "enable", matchIfMissing = true)
public class ZkzlTracerAutoConfiguration {
