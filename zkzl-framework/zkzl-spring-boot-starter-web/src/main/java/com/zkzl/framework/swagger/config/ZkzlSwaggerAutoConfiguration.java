package com.zkzl.framework.swagger.config;

import com.zkzl.framework.swagger.core.SpringFoxHandlerProviderBeanPostProcessor;
...
import static com.zkzl.framework.web.core.util.WebFrameworkUtils.HEADER_TENANT_ID;
...
@ConditionalOnProperty(prefix = "zkzl.swagger", value = "enable", matchIfMissing = true)
@EnableConfigurationProperties(SwaggerProperties.class)
public class ZkzlSwaggerAutoConfiguration {
...
//                .apis(basePackage("com.zkzl.module.system")) // 可用于 swagger 无法展示时使用
