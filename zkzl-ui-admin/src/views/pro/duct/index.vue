<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column label="产品类别id" align="center" prop="typeId" />
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          ...
          <el-button size="mini" type="text" icon="el-icon-delete" @click="handleDelete(scope.row)"
                     v-hasPermi="['pro:duct:delete']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <!-- 分页组件 -->
...
<script>
import { createduct, updateduct, deleteduct, getduct, getductPage, exportductExcel } from "@/api/pro/duct";
  ...
  data() {
    return {
      ...
      rules: {
        ...
        typeId: [{ required: true, message: "产品类别id不能为空", trigger: "blur" }],
