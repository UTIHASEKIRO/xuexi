<template>
  <div class="app-container">
    ...
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="父参数id" prop="parentParamId">
        <el-input v-model="queryParams.parentParamId" placeholder="请输入父参数id" clearable @keyup.enter.native="handleQuery"/>
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column label="参数id" align="center" prop="productId" />
      <el-table-column label="父参数id" align="center" prop="parentParamId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" v-dialogDrag append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="参数id" prop="productId">
          <el-input v-model="form.productId" placeholder="请输入参数id" />
        </el-form-item>
        <el-form-item label="父参数id" prop="parentParamId">
          <el-input v-model="form.parentParamId" placeholder="请输入父参数id" />
        </el-form-item>
        <el-form-item label="参数名" prop="parameter">
          <el-input v-model="form.parameter" placeholder="请输入参数名" />
        </el-form-item>
        <el-form-item label="值" prop="value">
...
export default {
  ...
  data() {
    return {
      ...
      // 表单校验
      rules: {
        productId: [{ required: true, message: "参数id不能为空", trigger: "blur" }],
        parentParamId: [{ required: true, message: "父参数id不能为空", trigger: "blur" }],
      }
    };
  },
  created() {
    ...
    submitForm() {
      this.$refs["form"].validate(valid => {
        ...
        if (this.form.id != null) {
          updateductParameters(this.form).then(response => {
        ...
        // 添加的提交
        createductParameters(this.form).then(response => {
