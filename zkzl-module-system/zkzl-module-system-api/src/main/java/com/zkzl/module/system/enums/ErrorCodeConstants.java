package com.zkzl.module.system.enums;
...
public interface ErrorCodeConstants {
    ...
    ErrorCode AUTH_PURVIEW_NOT_EXISTS = new ErrorCode(1002000008, "您没有权限");
    ...
    ErrorCode PRICE_INQURY_NEED_PRICE_DATE = new ErrorCode(1002023056, "询价单 需要报价时间！点击确定后成交！");
    ...
    ErrorCode ORDER_COST_NOT_EXISTS = new ErrorCode(1002023024, "订单成本不存在");
