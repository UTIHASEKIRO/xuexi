package com.zkzl.module.system.service.user;
...
import com.zkzl.module.infra.api.file.FileApi;
...
import com.zkzl.module.system.dal.dataobject.dept.UserPostDO;
...
import com.zkzl.module.system.dal.mysql.dept.UserPostMapper;
import com.zkzl.module.system.dal.mysql.user.AdminUserMapper;
import com.zkzl.module.system.enums.common.SexEnum;
import com.zkzl.module.system.service.dept.DeptService;
import com.zkzl.module.system.service.dept.PostService;
import com.zkzl.module.system.service.permission.PermissionService;
import com.zkzl.module.system.service.tenant.TenantService;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("zkzlyuanma");
        ...
        assertEquals("zkzlyuanma", user.getPassword());
    ...
    public void testImportUsers_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("zkzlyuanma"))).thenReturn("java");
