...
public class LoginLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetLoginLogPage() {
        ...
        LoginLogDO loginLogDO = RandomUtils.randomPojo(LoginLogDO.class, logDO -> {
            logDO.setLogType(RandomUtil.randomEle(com.zkzl.module.system.enums.logger.LoginLogTypeEnum.values()).getType());
            ...
            logDO.setResult(com.zkzl.module.system.enums.logger.LoginResultEnum.SUCCESS.getResult());
        });
        loginLogMapper.insert(loginLogDO);

        // 下面几个都是不匹配的数据
        // 登录失败的
        loginLogMapper.insert(ObjectUtils.cloneIgnoreId(loginLogDO, logDO -> logDO.setResult(com.zkzl.module.system.enums.logger.LoginResultEnum.CAPTCHA_CODE_ERROR.getResult())));
        // 不同ip段的
