package com.zkzl.module.system.service.social;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.lang.Assert;
import com.zkzl.framework.common.util.http.HttpUtils;
import com.zkzl.framework.social.core.ZkzlAuthRequestFactory;
import com.zkzl.module.system.api.social.dto.SocialUserBindReqDTO;
import com.zkzl.module.system.dal.dataobject.social.SocialUserBindDO;
import com.zkzl.module.system.dal.dataobject.social.SocialUserDO;
import com.zkzl.module.system.dal.mysql.social.SocialUserBindMapper;
import com.zkzl.module.system.dal.mysql.social.SocialUserMapper;
import com.zkzl.module.system.enums.social.SocialTypeEnum;
...
public class SocialUserServiceImpl implements SocialUserService {
    ...
    @Resource// 由于自定义了 ZkzlAuthRequestFactory 无法覆盖默认的 AuthRequestFactory，所以只能注入它
    private ZkzlAuthRequestFactory zkzlAuthRequestFactory;
    ...
    public String getAuthorizeUrl(Integer type, String redirectUri) {
        ...
        AuthRequest authRequest = zkzlAuthRequestFactory.get(SocialTypeEnum.valueOfType(type).getSource());
        // 生成跳转地址
