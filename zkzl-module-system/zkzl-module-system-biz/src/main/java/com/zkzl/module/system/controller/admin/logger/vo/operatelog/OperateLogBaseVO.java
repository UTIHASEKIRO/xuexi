package com.zkzl.module.system.controller.admin.logger.vo.operatelog;
...
public class OperateLogBaseVO {
    ...
    @ApiModelProperty(value = "Java 方法名", required = true, example = "com.zkzl.adminserver.UserController.save(...)")
