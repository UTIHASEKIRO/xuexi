package com.zkzl.module.system.controller.admin.user.vo.user;

import com.zkzl.framework.common.validation.Mobile;
...
public class UserBaseVO {
    ...
    @ApiModelProperty(value = "用户账号", required = true, example = "zkzl")
...
/*    @Pattern(regexp = "^[a-zA-Z0-9]{4,30}$", message = "用户账号由 数字、字母 组成")*/
    ...
    @ApiModelProperty(value = "用户邮箱", example = "zkzl@iocoder.cn")
