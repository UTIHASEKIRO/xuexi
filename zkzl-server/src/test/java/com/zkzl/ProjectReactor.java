...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "top.code.zkzl";
    private static final String ARTIFACT_ID = "zkzl";
    private static final String PACKAGE_NAME = "com.zkzl";
    private static final String TITLE = "快速开发管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "top.code.zkzl";
        String artifactIdNew = "zkzl";
        String packageNameNew = "com.zkzl";
        String titleNew = "快速开发管理系统";
        String projectBaseDirNew = "D:/DEV/ideworkspace/zkzl/vue-pro"; // 一键改名后，“新”项目所在的目录
