...
import com.zkzl.module.bpm.service.task.BpmActivityService;
import com.zkzl.module.bpm.service.task.BpmTaskService;
...
public class BpmTaskEventListener extends AbstractFlowableEngineEventListener {
    ...
    public static final Set<FlowableEngineEventType> TASK_EVENTS = ImmutableSet.<FlowableEngineEventType>builder()
            ...
            .add(FlowableEngineEventType.TASK_ASSIGNED)//当任务被注册时（即流程发起时）
    ...
    @Override
    protected void taskAssigned(FlowableEngineEntityEvent event) {//当任务被注册时（即流程发起时）
