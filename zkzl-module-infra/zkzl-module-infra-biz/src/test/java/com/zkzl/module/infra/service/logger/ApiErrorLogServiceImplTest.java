package com.zkzl.module.infra.service.logger;
...
import com.zkzl.framework.test.core.util.RandomUtils;
import com.zkzl.module.infra.api.logger.dto.ApiErrorLogCreateReqDTO;
import com.zkzl.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogExportReqVO;
import com.zkzl.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import com.zkzl.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import com.zkzl.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import com.zkzl.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static com.zkzl.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static com.zkzl.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        String applicationName = "zkzl-test";
