package com.zkzl.module.member.service.auth;
...
import com.zkzl.module.member.controller.app.auth.vo.AppAuthResetPasswordReqVO;
import com.zkzl.module.member.controller.app.auth.vo.AppAuthUpdatePasswordReqVO;
import com.zkzl.module.member.dal.dataobject.user.MemberUserDO;
import com.zkzl.module.member.dal.mysql.user.MemberUserMapper;
import com.zkzl.module.member.service.user.MemberUserService;
import com.zkzl.module.system.api.oauth2.OAuth2TokenApi;
import com.zkzl.module.system.api.logger.LoginLogApi;
 ...
 * @author 宋天
 */
@Import({MemberAuthServiceImpl.class, ZkzlRedisAutoConfiguration.class})
