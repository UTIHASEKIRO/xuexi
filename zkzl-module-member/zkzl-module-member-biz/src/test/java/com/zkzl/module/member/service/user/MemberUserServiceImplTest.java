package com.zkzl.module.member.service.user;
...
import com.zkzl.module.member.controller.app.user.vo.AppUserUpdateMobileReqVO;
...
import com.zkzl.module.member.service.auth.MemberAuthServiceImpl;
 ...
 * @author 宋天
 */
@Import({MemberUserServiceImpl.class, ZkzlRedisAutoConfiguration.class})
